...
### Encapsulation of class field constants (3.1.3):
...
### Encapsulation of class overlap logic (3.1.4):
...
### High Coupling in `ClassList.post()` (3.2.1):
...
### Single Responsibility Principle in `ClassList.post()` (3.3.2):
...
### Open–Closed Principle in authorization logic (3.4.3):
...
### Long Method in `ClassList.post()` (4.1.2):
...
### Long Method in `get_upcoming_classes_grouped_by_week()` (4.1.3):
...
### Duplicate Code in validation logic (4.4.2):
